      ...
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold text-white">Rocket</h1>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="name" name="name" placeholder="John Doe" required className="bg-gray-800 border-gray-700" />
              </div>
              <div className="space-y-2">
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <div className="relative flex items-center justify-center">
                ...
                <span className="relative bg-gray-900 px-2 text-xs text-gray-400">OR CONTINUE WITH</span>
              </div>
